import{_ as s,o as n,c as p,a4 as t}from"./chunks/framework.DyX1TuK3.js";const d=JSON.parse('{"title":"可帶走的 Prompt","description":"","frontmatter":{},"headers":[],"relativePath":"prompts.md","filePath":"prompts.md"}'),e={name:"prompts.md"};function l(i,a,o,r,c,h){return n(),p("div",null,[...a[0]||(a[0]=[t(`<h1 id="可帶走的-prompt" tabindex="-1">可帶走的 Prompt <a class="header-anchor" href="#可帶走的-prompt" aria-label="Permalink to &quot;可帶走的 Prompt&quot;">​</a></h1><p>AI-native 工作流的一個切面:不是每個功能都得做成系統。有些能力可以直接做成一段<strong>可複製的 prompt</strong> — 編輯貼進任何 chatbot(ChatGPT / Claude / Gemini)就能用,零安裝、零後端。</p><p>註:這裡只放<strong>代表性</strong>的維度與標籤當示範;團隊實際使用的是完整 14 維、四百多個標籤的版本(內部文件,不公開)。重點是展示「把判斷力封裝成可攜 prompt」這個做法,不是公開分類體系本身。</p><h2 id="電影自動標籤-prompt" tabindex="-1">電影自動標籤 prompt <a class="header-anchor" href="#電影自動標籤-prompt" aria-label="Permalink to &quot;電影自動標籤 prompt&quot;">​</a></h2><p>點右上角複製,貼到任何 chatbot,把最後兩行換成你的片名與劇情即可。</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>你是電影標籤助手。我會給你一部片的片名與劇情,你要從下方維度選出貼切的標籤。</span></span>
